    ...
    return (
     ...
     <div className='row'>
     {
            this.state.articles.map((element)=>{
                ...
                imageurl={element.urlToImage?element.urlToImage:"https://image.cnbcfm.com/api/v1/image/107257944-1686871334383-gettyimages-1258302640-JAPAN_BOJ.jpeg?v=1686873160&w=1920&h=1080"} newsUrl={element.url} />
        </div>})}
       </div>
